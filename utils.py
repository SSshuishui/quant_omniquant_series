...
def create_logger(method_name, output_dir, dist_rank=0, name=''):
    # create logger
    ...
    file_handler = logging.FileHandler(os.path.join(output_dir, f'{method_name}_log_rank{dist_rank}_{int(time.time())}.txt'), mode='a')
