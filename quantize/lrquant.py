...
def RLQuant(
    ...
    if "llama" in args.net.lower():
        ...
        DecoderLayer = LRQuantLlamaDecoderLayer
        pairs = {
            "q_proj":"qkv",
            "o_proj":"out",
            "up_proj":"fc1"
        ...
        DecoderLayer = LRQuantOPTDecoderLayer
        pairs = {
            "q_proj":"qkv",
            "out_proj":"out",
            "fc1":"fc1"
    ...
    for i in range(len(layers)):
        ...
        if args.epochs>0:
            ...
            torch.save(rlq_parameters, os.path.join(args.save_dir, f"{args.net}-rlq_parameters.pth"))
        else:
            qlayer.register_scales_and_zeros()
            qlayer.half()
            layers[i] = qlayer.to("cpu")    
